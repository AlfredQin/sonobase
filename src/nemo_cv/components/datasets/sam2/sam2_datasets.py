...
class MixedDataLoader:
    def __init__(self, dataloaders: List[DataLoader], mixing_prob: torch.FloatTensor, seed: int = 42):
        """
        Args:
...
class TorchTrainMixedDataset:
    ...
    def get_loader(self, epoch) -> Iterable:
        ...
        for d_idx, (dataset, batch_size) in enumerate(
            ...
            sampler = DistributedSampler(dataset, shuffle=self.shuffle, seed=self.seed)
        ...
        return MixedDataLoader(dataloaders, self.dataset_prob, self.seed)
