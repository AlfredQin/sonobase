...
from .vos_raw_dataset import VOSRawDataset
from .vos_sampler import VOSSampler
from .vos_segment_loader import JSONSegmentLoader

from .data_utils import Frame, Object, VideoDatapoint
...
class VOSDataset(VisionDataset):
    def __init__(
        ...
        self._transforms = transforms if isinstance(transforms, (list, tuple)) else [transforms]
