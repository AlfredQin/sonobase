...
try:
    ...
    logger.warning('The MultiScaleDeformableAttention extension is not built, will import it from transformers lib.')
    from transformers.models.deformable_detr.modeling_deformable_detr import MultiScaleDeformableAttention as MSDA
import math
...
def ms_deform_attn_core_pytorch_key_aware(
        query, value, key, value_spatial_shapes, sampling_locations,
):
    # for debug and test only,
    # need to use cuda version instead
